...
public class Simulateur {
	 ...
	 * <br>
	 * <dt> -form f </dt><dd>  codage (String) RZ, NRZR, NRZT, la forme d'onde du signal à transmettre (RZ par dÈfaut)</dd>
	...
	/** La methode qui calcule le taux d'erreur binaire en comparant les bits du message emis avec ceux du message reçu.
	 *
